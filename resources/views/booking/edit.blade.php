        ...
        <div class="row">
            <div class="col">
                <div class="form-group">
                  <label for="booking_date">Booking Date</label>
                    <input type="date" name="booking_date" id="booking_date" value="{{ $booking->booking_date->format('Y-m-d') }}" class="form-control @error('booking_date') {{'is-invalid'}} @enderror" placeholder="" >
            ...
            <div class="col">
                <div class="form-group">
                  ...
                  <input type="number" name="seats_nbr" min="1" max="20" id="seats_nbr" value="{{ $booking->seats_nbr }}" class="form-control @error('seats_nbr') {{'is-invalid'}} @enderror" placeholder="" >
